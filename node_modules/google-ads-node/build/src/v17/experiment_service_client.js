...
class ExperimentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const scheduleExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v17.services.ScheduleExperimentMetadata');
        const promoteExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v17.services.PromoteExperimentMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v17.services.ExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.experimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v17.services.ExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v17.services.ExperimentService, this._opts, this._providedCustomServicePath);
