...
class BatchJobServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const runBatchJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v17.resources.BatchJob.BatchJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v17.services.BatchJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v17.services.BatchJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v17.services.BatchJobService, this._opts, this._providedCustomServicePath);
