...
class AudienceInsightsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v17.services.AudienceInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.audienceInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v17.services.AudienceInsightsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v17.services.AudienceInsightsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const audienceInsightsServiceStubMethods = ['generateInsightsFinderReport', 'listAudienceInsightsAttributes', 'listInsightsEligibleDates', 'generateAudienceCompositionInsights', 'generateSuggestedTargetingInsights', 'generateAudienceOverlapInsights'];
